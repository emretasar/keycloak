 ...
 */
public class MobileSignIdentityProvider extends AbstractOAuth2IdentityProvider implements SocialIdentityProvider {
    ...
    public MobileSignIdentityProvider(KeycloakSession session, OAuth2IdentityProviderConfig config) {
